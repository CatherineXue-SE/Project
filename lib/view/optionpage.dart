            ...
            child: ListView(
              children: <Widget>[
                ...
                ListTile(
                  ...
                  title: Text('Profile'),
                  onTap: () => controller.editAccount(),
                ),
                ListTile(
                  leading: Icon(Icons.people),
                  title: Text('View Records'),
                  onTap: () =>controller.ViewRecord(),
                ),
                ListTile(
...
class OptionPageState extends State<OptionPage>
{
  ...
  List<Record> records;
  int radioValue = 3 ; 
  var listinfo = List<String>();
  Socket socket;

  IOWebSocketChannel channel  = IOWebSocketChannel.connect("ws://localhost:2020");
  ...
  void sendMessage() async{
   ...
   Socket.connect("localhost", 4040).then((Socket sock) {
     print('connected');
   socket = sock;
   socket.write('1-o');
   sock.listen(
